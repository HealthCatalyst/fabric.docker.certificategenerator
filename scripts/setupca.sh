...
openssl req -x509 -config openssl.cnf -key /opt/healthcatalyst/testca/private/cakey.pem -days 3650 -out cacert.pem -outform PEM -subj /CN=FabricCertificateAuthority/O=HealthCatalyst/ -nodes
